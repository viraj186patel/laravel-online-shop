    ...
    <section class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                        ...
                        <div class="card-header pt-3">
                            <div class="row invoice-info">
                                ...
                                <div class="col-sm-4 invoice-col">
                                    ...
                                    @else
                                        <span class="text-dark">Cancelled</span>
                                    @endif
                                    <br>
                                </div>
                            </div>
                ...
                <div class="col-md-3">
                    <div class="card">
                        <form action="" method="post" name="orderStatusForm" id="orderStatusForm">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="shipped_date" id="shipped_date" class="form-control" value="{{ $order->shipped_date }}" autocomplete="off" placeholder="Shipped Date">
                            </div>
                            <div class="mb-3">
